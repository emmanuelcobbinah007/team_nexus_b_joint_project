...
- [x] `docs/report/` — sections 1-9 have real content; **10 (individual contributions) and 11 (conclusion) still need to be written** — see below
...
- [ ] Section 8 (benchmarks): T070 (hash table load factor), T071 (BST vs.
      balanced tree), T072 (triage-priority vs. FCFS) still outstanding —
      only T073 (graph algorithms) has real results as of this writing
